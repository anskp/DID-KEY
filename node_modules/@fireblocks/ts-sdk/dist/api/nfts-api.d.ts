...
export declare const NFTsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    refreshNFTMetadata: (id: string, xEndUserWalletId?: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    updateTokenOwnershipStatus: (updateTokenOwnershipStatusDto: UpdateTokenOwnershipStatusDto, id: string, xEndUserWalletId?: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    updateTokensOwnershipSpam: (updateTokensOwnershipSpamRequest: UpdateTokensOwnershipSpamRequest, xEndUserWalletId?: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    updateTokensOwnershipStatus: (updateTokensOwnershipStatusRequest: UpdateTokensOwnershipStatusRequest, xEndUserWalletId?: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const NFTsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    refreshNFTMetadata(id: string, xEndUserWalletId?: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Updates all tokens and balances per blockchain and vault account.
     * @summary Refresh vault account tokens
     * @param {UpdateOwnershipTokensBlockchainDescriptorEnum} blockchainDescriptor Blockchain descriptor filter
     ...
     * @throws {RequiredError}
     */
    updateTokenOwnershipStatus(updateTokenOwnershipStatusDto: UpdateTokenOwnershipStatusDto, id: string, xEndUserWalletId?: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Updates tokens spam property for a tenant\'s token ownerships, in all tenant vaults.
     * @summary Update tokens ownership spam property
     * @param {UpdateTokensOwnershipSpamRequest} updateTokensOwnershipSpamRequest
     ...
     * @throws {RequiredError}
     */
    updateTokensOwnershipSpam(updateTokensOwnershipSpamRequest: UpdateTokensOwnershipSpamRequest, xEndUserWalletId?: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Updates tokens status for a tenant, in all tenant vaults.
     * @summary Update tokens ownership status
     * @param {UpdateTokensOwnershipStatusRequest} updateTokensOwnershipStatusRequest
     ...
     * @throws {RequiredError}
     */
    updateTokensOwnershipStatus(updateTokensOwnershipStatusRequest: UpdateTokensOwnershipStatusRequest, xEndUserWalletId?: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
};
/**
...
export declare const GetOwnershipTokensBlockchainDescriptorEnum: {
    ...
    readonly BasechainEthTest5: "BASECHAIN_ETH_TEST5";
    readonly Etherlink: "ETHERLINK";
    readonly EtherlinkTest: "ETHERLINK_TEST";
    readonly Mantle: "MANTLE";
    readonly MantleTest: "MANTLE_TEST";
    readonly GunGunzilla: "GUN_GUNZILLA";
    readonly GunGunzillaTest: "GUN_GUNZILLA_TEST";
    readonly EthSoneium: "ETH_SONEIUM";
    readonly SoneiumMinatoTest: "SONEIUM_MINATO_TEST";
    readonly IotxIotex: "IOTX_IOTEX";
    readonly KlayKaia: "KLAY_KAIA";
    readonly KlayKaiaTest: "KLAY_KAIA_TEST";
    readonly Apechain: "APECHAIN";
    readonly ApechainTest: "APECHAIN_TEST";
};
