...
export declare const Web3ConnectionsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    create: (createConnectionRequest: CreateConnectionRequest, idempotencyKey?: string, xEndUserWalletId?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    get: (xEndUserWalletId?: string, order?: GetOrderEnum, filter?: GetFilterParameter, sort?: GetSortEnum, pageSize?: number, next?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    remove: (id: string, xEndUserWalletId?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    submit: (respondToConnectionRequest: RespondToConnectionRequest, id: string, idempotencyKey?: string, xEndUserWalletId?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const Web3ConnectionsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    create(createConnectionRequest: CreateConnectionRequest, idempotencyKey?: string, xEndUserWalletId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateConnectionResponse>>;
    /**
     * Get open Web3 connections.
     * @summary List all open Web3 connections.
     * @param {string} [xEndUserWalletId] Unique ID of the End-User wallet to the API request. Required for end-user wallet operations.
     ...
     * @throws {RequiredError}
     */
    get(xEndUserWalletId?: string, order?: GetOrderEnum, filter?: GetFilterParameter, sort?: GetSortEnum, pageSize?: number, next?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetConnectionsResponse>>;
    /**
     * Remove a Web3 connection
     * @summary Remove an existing Web3 connection.
     * @param {string} id The ID of the existing Web3 connection to remove.
     ...
     * @throws {RequiredError}
     */
    remove(id: string, xEndUserWalletId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Submit a response to *approve* or *reject* an initiated Web3 connection. * Note: This call is used to complete your `POST /v1/connections/wc/` request.  After this succeeds, your new Web3 connection is created and functioning.
     * @summary Respond to a pending Web3 connection request.
     * @param {RespondToConnectionRequest} respondToConnectionRequest
     ...
     * @throws {RequiredError}
     */
    submit(respondToConnectionRequest: RespondToConnectionRequest, id: string, idempotencyKey?: string, xEndUserWalletId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
};
/**
