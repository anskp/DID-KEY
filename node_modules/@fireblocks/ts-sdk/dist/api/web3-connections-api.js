...
var Web3ConnectionsApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        create: function (createConnectionRequest, idempotencyKey, xEndUserWalletId, options) {
         ...
         * @throws {RequiredError}
         */
        get: function (xEndUserWalletId, order, filter, sort, pageSize, next, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
         ...
         * @throws {RequiredError}
         */
        remove: function (id, xEndUserWalletId, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
         ...
         * @throws {RequiredError}
         */
        submit: function (respondToConnectionRequest, id, idempotencyKey, xEndUserWalletId, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
    ...
    return {
        ...
        create: function (createConnectionRequest, idempotencyKey, xEndUserWalletId, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.create(createConnectionRequest, idempotencyKey, xEndUserWalletId, options)];
                        case 1:
        ...
        get: function (xEndUserWalletId, order, filter, sort, pageSize, next, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.get(xEndUserWalletId, order, filter, sort, pageSize, next, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
        ...
        remove: function (id, xEndUserWalletId, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.remove(id, xEndUserWalletId, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
        ...
        submit: function (respondToConnectionRequest, id, idempotencyKey, xEndUserWalletId, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.submit(respondToConnectionRequest, id, idempotencyKey, xEndUserWalletId, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
...
var Web3ConnectionsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
        ...
        create: function (requestParameters, options) {
            return localVarFp.create(requestParameters.createConnectionRequest, requestParameters.idempotencyKey, requestParameters.xEndUserWalletId, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Get open Web3 connections.
         * @summary List all open Web3 connections.
        ...
        get: function (requestParameters, options) {
            ...
            return localVarFp.get(requestParameters.xEndUserWalletId, requestParameters.order, requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.next, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Remove a Web3 connection
         * @summary Remove an existing Web3 connection.
        ...
        remove: function (requestParameters, options) {
            return localVarFp.remove(requestParameters.id, requestParameters.xEndUserWalletId, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Submit a response to *approve* or *reject* an initiated Web3 connection. * Note: This call is used to complete your `POST /v1/connections/wc/` request.  After this succeeds, your new Web3 connection is created and functioning.
         * @summary Respond to a pending Web3 connection request.
        ...
        submit: function (requestParameters, options) {
            return localVarFp.submit(requestParameters.respondToConnectionRequest, requestParameters.id, requestParameters.idempotencyKey, requestParameters.xEndUserWalletId, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
...
var Web3ConnectionsApi = /** @class */ (function (_super) {
    ...
    Web3ConnectionsApi.prototype.create = function (requestParameters) {
        var _this = this;
        return (0, exports.Web3ConnectionsApiFp)(this.configuration).create(requestParameters.createConnectionRequest, requestParameters.idempotencyKey, requestParameters.xEndUserWalletId).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Get open Web3 connections.
     * @summary List all open Web3 connections.
    ...
    Web3ConnectionsApi.prototype.get = function (requestParameters) {
        var _this = this;
        if (requestParameters === void 0) { requestParameters = {}; }
        return (0, exports.Web3ConnectionsApiFp)(this.configuration).get(requestParameters.xEndUserWalletId, requestParameters.order, requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.next).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Remove a Web3 connection
     * @summary Remove an existing Web3 connection.
    ...
    Web3ConnectionsApi.prototype.remove = function (requestParameters) {
        var _this = this;
        return (0, exports.Web3ConnectionsApiFp)(this.configuration).remove(requestParameters.id, requestParameters.xEndUserWalletId).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Submit a response to *approve* or *reject* an initiated Web3 connection. * Note: This call is used to complete your `POST /v1/connections/wc/` request.  After this succeeds, your new Web3 connection is created and functioning.
     * @summary Respond to a pending Web3 connection request.
    ...
    Web3ConnectionsApi.prototype.submit = function (requestParameters) {
        var _this = this;
        return (0, exports.Web3ConnectionsApiFp)(this.configuration).submit(requestParameters.respondToConnectionRequest, requestParameters.id, requestParameters.idempotencyKey, requestParameters.xEndUserWalletId).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
