 ...
 * @export
 */
export declare const JobManagementApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     */
    cancelJob: (jobId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    continueJob: (jobId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getJobTasks: (jobId: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getJobs: (fromTime?: number, toTime?: number, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    pauseJob: (jobId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * JobManagementApi - functional programming interface
 * @export
 */
export declare const JobManagementApiFp: (configuration?: Configuration) => {
    /**
     * Stop the given job immediately. If the job is in the \'Active\' state, the job will be canceled after completing the current task. Vault accounts and Wallets that are already created will not be affected.
     * @summary Cancel a running job
     * @param {string} jobId The requested job id
     ...
     * @throws {RequiredError}
     */
    cancelJob(jobId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Continue the given paused job.
     * @summary Continue a paused job
     * @param {string} jobId The requested job id
     ...
     * @throws {RequiredError}
     */
    continueJob(jobId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Get an object describing the given job
     * @summary Get job details
     * @param {string} jobId The requested job id
     ...
     * @throws {RequiredError}
     */
    getJobTasks(jobId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Tasks>>;
    /**
     * Get an array of objects including all active, paused, canceled, and complete jobs in a workspace.
     * @summary Return a list of jobs belonging to tenant
     * @param {number} [fromTime] Start of time range in ms since 1970
     ...
     * @throws {RequiredError}
     */
    getJobs(fromTime?: number, toTime?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Jobs>>;
    /**
     * Pause the given job, after the current task is done. A paused job can later be resumed by calling \'continue\', or canceled.
     * @summary Pause a job
     * @param {string} jobId The requested job id
     ...
     * @throws {RequiredError}
     */
    pauseJob(jobId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
};
/**
 * JobManagementApi - factory interface
 * @export
 */
export declare const JobManagementApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Stop the given job immediately. If the job is in the \'Active\' state, the job will be canceled after completing the current task. Vault accounts and Wallets that are already created will not be affected.
     * @summary Cancel a running job
 ...
 * @extends {BaseAPI}
 */
export declare class JobManagementApi extends BaseAPI {
    /**
     * Stop the given job immediately. If the job is in the \'Active\' state, the job will be canceled after completing the current task. Vault accounts and Wallets that are already created will not be affected.
     * @summary Cancel a running job
     * @param {JobManagementApiCancelJobRequest} requestParameters Request parameters.
     ...
     */
    cancelJob(requestParameters: JobManagementApiCancelJobRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<void>>;
    /**
     * Continue the given paused job.
     * @summary Continue a paused job
     * @param {JobManagementApiContinueJobRequest} requestParameters Request parameters.
     ...
     * @memberof JobManagementApi
     */
    continueJob(requestParameters: JobManagementApiContinueJobRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<void>>;
    /**
     * Get an object describing the given job
     * @summary Get job details
     * @param {JobManagementApiGetJobRequest} requestParameters Request parameters.
     ...
     * @memberof JobManagementApi
     */
    getJob(requestParameters: JobManagementApiGetJobRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<Job>>;
    /**
     * Return a list of tasks for given job
     * @summary Return a list of tasks for given job
     * @param {JobManagementApiGetJobTasksRequest} requestParameters Request parameters.
     ...
     * @memberof JobManagementApi
     */
    getJobTasks(requestParameters: JobManagementApiGetJobTasksRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<Tasks>>;
    /**
     * Get an array of objects including all active, paused, canceled, and complete jobs in a workspace.
     * @summary Return a list of jobs belonging to tenant
     * @param {JobManagementApiGetJobsRequest} requestParameters Request parameters.
     ...
     * @memberof JobManagementApi
     */
    getJobs(requestParameters?: JobManagementApiGetJobsRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<Jobs>>;
    /**
     * Pause the given job, after the current task is done. A paused job can later be resumed by calling \'continue\', or canceled.
     * @summary Pause a job
     * @param {JobManagementApiPauseJobRequest} requestParameters Request parameters.
     ...
     * @memberof JobManagementApi
     */
    pauseJob(requestParameters: JobManagementApiPauseJobRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<void>>;
}
