...
var TokenizationApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getDeployableAddress: function (getDeployableAddressRequest, idempotencyKey, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    (0, common_1.assertParamExists)('getDeployableAddress', 'getDeployableAddressRequest', getDeployableAddressRequest);
                    localVarPath = "/tokenization/multichain/deterministic_address";
                    localVarUrlObj = new url_1.URL(localVarPath, common_1.DUMMY_BASE_URL);
                    if (configuration) {
                        baseOptions = configuration.baseOptions;
                    }
                    ...
                    headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                    localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                    localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(getDeployableAddressRequest, localVarRequestOptions, configuration);
                    return [2 /*return*/, {
                            url: (0, common_1.toPathString)(localVarUrlObj),
                            options: localVarRequestOptions,
                        }];
         ...
         * @throws {RequiredError}
         */
        issueTokenMultiChain: function (createMultichainTokenRequest, idempotencyKey, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    (0, common_1.assertParamExists)('issueTokenMultiChain', 'createMultichainTokenRequest', createMultichainTokenRequest);
                    localVarPath = "/tokenization/multichain/tokens";
                    localVarUrlObj = new url_1.URL(localVarPath, common_1.DUMMY_BASE_URL);
                    if (configuration) {
                        baseOptions = configuration.baseOptions;
                    }
                    ...
                    headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                    localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                    localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(createMultichainTokenRequest, localVarRequestOptions, configuration);
                    return [2 /*return*/, {
                            url: (0, common_1.toPathString)(localVarUrlObj),
                            options: localVarRequestOptions,
                        }];
         ...
         * @throws {RequiredError}
         */
        reIssueTokenMultiChain: function (reissueMultichainTokenRequest, tokenLinkId, idempotencyKey, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    (0, common_1.assertParamExists)('reIssueTokenMultiChain', 'reissueMultichainTokenRequest', reissueMultichainTokenRequest);
                    (0, validation_utils_1.assertParamExistsAndNotEmpty)('reIssueTokenMultiChain', 'tokenLinkId', tokenLinkId);
                    localVarPath = "/tokenization/multichain/reissue/token/{tokenLinkId}"
                        .replace("{".concat("tokenLinkId", "}"), encodeURIComponent(String(tokenLinkId)));
                    localVarUrlObj = new url_1.URL(localVarPath, common_1.DUMMY_BASE_URL);
                    if (configuration) {
                        baseOptions = configuration.baseOptions;
                    }
                    ...
                    headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                    localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                    localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(reissueMultichainTokenRequest, localVarRequestOptions, configuration);
                    return [2 /*return*/, {
                            url: (0, common_1.toPathString)(localVarUrlObj),
                            options: localVarRequestOptions,
                        }];
    ...
    return {
        ...
        getDeployableAddress: function (getDeployableAddressRequest, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.getDeployableAddress(getDeployableAddressRequest, idempotencyKey, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['TokenizationApi.getDeployableAddress']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
        ...
        issueTokenMultiChain: function (createMultichainTokenRequest, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.issueTokenMultiChain(createMultichainTokenRequest, idempotencyKey, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['TokenizationApi.issueTokenMultiChain']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
        ...
        reIssueTokenMultiChain: function (reissueMultichainTokenRequest, tokenLinkId, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.reIssueTokenMultiChain(reissueMultichainTokenRequest, tokenLinkId, idempotencyKey, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['TokenizationApi.reIssueTokenMultiChain']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
...
var TokenizationApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getDeployableAddress: function (requestParameters, options) {
            return localVarFp.getDeployableAddress(requestParameters.getDeployableAddressRequest, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Get collections (paginated)
         * @summary Get collections
         ...
         * @throws {RequiredError}
         */
        issueTokenMultiChain: function (requestParameters, options) {
            return localVarFp.issueTokenMultiChain(requestParameters.createMultichainTokenRequest, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Link an a contract
         * @summary Link a contract
         ...
         * @throws {RequiredError}
         */
        reIssueTokenMultiChain: function (requestParameters, options) {
            return localVarFp.reIssueTokenMultiChain(requestParameters.reissueMultichainTokenRequest, requestParameters.tokenLinkId, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Unlink a token. The token will be unlinked from the workspace. The token will not be deleted on chain nor the refId, only the link to the workspace will be removed.
         * @summary Unlink a token
...
var TokenizationApi = /** @class */ (function (_super) {
     ...
     * @memberof TokenizationApi
     */
    TokenizationApi.prototype.getDeployableAddress = function (requestParameters) {
        var _this = this;
        return (0, exports.TokenizationApiFp)(this.configuration).getDeployableAddress(requestParameters.getDeployableAddressRequest, requestParameters.idempotencyKey).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Get collections (paginated)
     * @summary Get collections
     ...
     * @memberof TokenizationApi
     */
    TokenizationApi.prototype.issueTokenMultiChain = function (requestParameters) {
        var _this = this;
        return (0, exports.TokenizationApiFp)(this.configuration).issueTokenMultiChain(requestParameters.createMultichainTokenRequest, requestParameters.idempotencyKey).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Link an a contract
     * @summary Link a contract
     ...
     * @memberof TokenizationApi
     */
    TokenizationApi.prototype.reIssueTokenMultiChain = function (requestParameters) {
        var _this = this;
        return (0, exports.TokenizationApiFp)(this.configuration).reIssueTokenMultiChain(requestParameters.reissueMultichainTokenRequest, requestParameters.tokenLinkId, requestParameters.idempotencyKey).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Unlink a token. The token will be unlinked from the workspace. The token will not be deleted on chain nor the refId, only the link to the workspace will be removed.
     * @summary Unlink a token
