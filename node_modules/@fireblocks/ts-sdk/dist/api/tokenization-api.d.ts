...
export declare const TokenizationApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getDeployableAddress: (getDeployableAddressRequest: GetDeployableAddressRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    issueTokenMultiChain: (createMultichainTokenRequest: CreateMultichainTokenRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     * Link an a contract
     ...
     * @throws {RequiredError}
     */
    reIssueTokenMultiChain: (reissueMultichainTokenRequest: ReissueMultichainTokenRequest, tokenLinkId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const TokenizationApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getDeployableAddress(getDeployableAddressRequest: GetDeployableAddressRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DeployableAddressResponse>>;
    /**
     * Get collections (paginated)
     * @summary Get collections
     * @param {string} [pageCursor] Page cursor to get the next page, for example - \&quot;MjAyMy0xMi0xMyAyMDozNjowOC4zMDI&#x3D;:MTEwMA&#x3D;&#x3D;\&quot;
     ...
     * @throws {RequiredError}
     */
    issueTokenMultiChain(createMultichainTokenRequest: CreateMultichainTokenRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IssueTokenMultichainResponse>>;
    /**
     * Link an a contract
     * @summary Link a contract
     * @param {TokenLinkRequestDto} tokenLinkRequestDto
     ...
     * @throws {RequiredError}
     */
    reIssueTokenMultiChain(reissueMultichainTokenRequest: ReissueMultichainTokenRequest, tokenLinkId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IssueTokenMultichainResponse>>;
    /**
     * Unlink a token. The token will be unlinked from the workspace. The token will not be deleted on chain nor the refId, only the link to the workspace will be removed.
     * @summary Unlink a token
     * @param {string} id The token link id
...
export declare class TokenizationApi extends BaseAPI {
     ...
     * @memberof TokenizationApi
     */
    getDeployableAddress(requestParameters: TokenizationApiGetDeployableAddressRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<DeployableAddressResponse>>;
    /**
     * Get collections (paginated)
     * @summary Get collections
     * @param {TokenizationApiGetLinkedCollectionsRequest} requestParameters Request parameters.
     ...
     * @memberof TokenizationApi
     */
    issueTokenMultiChain(requestParameters: TokenizationApiIssueTokenMultiChainRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<IssueTokenMultichainResponse>>;
    /**
     * Link an a contract
     * @summary Link a contract
     * @param {TokenizationApiLinkRequest} requestParameters Request parameters.
     ...
     * @memberof TokenizationApi
     */
    reIssueTokenMultiChain(requestParameters: TokenizationApiReIssueTokenMultiChainRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<IssueTokenMultichainResponse>>;
    /**
     * Unlink a token. The token will be unlinked from the workspace. The token will not be deleted on chain nor the refId, only the link to the workspace will be removed.
     * @summary Unlink a token
     * @param {TokenizationApiUnlinkRequest} requestParameters Request parameters.
