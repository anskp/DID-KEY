...
var ExchangeAccountsApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        addExchangeAccount: function (addExchangeAccountRequest, idempotencyKey, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    (0, common_1.assertParamExists)('addExchangeAccount', 'addExchangeAccountRequest', addExchangeAccountRequest);
                    localVarPath = "/exchange_accounts";
                    ...
                    localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(addExchangeAccountRequest, localVarRequestOptions, configuration);
                    return [2 /*return*/, {
         ...
         * @throws {RequiredError}
         */
        getExchangeAccountsCredentialsPublicKey: function (options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    localVarPath = "/exchange_accounts/credentials_public_key";
                    localVarUrlObj = new url_1.URL(localVarPath, common_1.DUMMY_BASE_URL);
                    if (configuration) {
                        baseOptions = configuration.baseOptions;
                    }
    ...
    return {
        ...
        addExchangeAccount: function (addExchangeAccountRequest, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.addExchangeAccount(addExchangeAccountRequest, idempotencyKey, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['ExchangeAccountsApi.addExchangeAccount']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
        ...
        getExchangeAccountsCredentialsPublicKey: function (options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.getExchangeAccountsCredentialsPublicKey(options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['ExchangeAccountsApi.getExchangeAccountsCredentialsPublicKey']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
...
var ExchangeAccountsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        addExchangeAccount: function (requestParameters, options) {
            return localVarFp.addExchangeAccount(requestParameters.addExchangeAccountRequest, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Convert exchange account funds from the source asset to the destination asset. Coinbase (USD to USDC, USDC to USD) and Bitso (MXN to USD) are supported conversions.
         * @summary Convert exchange account funds from the source asset to the destination asset.
         ...
         */
        getExchangeAccountsCredentialsPublicKey: function (options) {
            return localVarFp.getExchangeAccountsCredentialsPublicKey(options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Returns a page include exchange accounts.
         * @summary Pagination list exchange accounts
...
var ExchangeAccountsApi = /** @class */ (function (_super) {
     ...
     */
    ExchangeAccountsApi.prototype.addExchangeAccount = function (requestParameters) {
        var _this = this;
        return (0, exports.ExchangeAccountsApiFp)(this.configuration).addExchangeAccount(requestParameters.addExchangeAccountRequest, requestParameters.idempotencyKey).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Convert exchange account funds from the source asset to the destination asset. Coinbase (USD to USDC, USDC to USD) and Bitso (MXN to USD) are supported conversions.
     * @summary Convert exchange account funds from the source asset to the destination asset.
     ...
     * @memberof ExchangeAccountsApi
     */
    ExchangeAccountsApi.prototype.getExchangeAccountsCredentialsPublicKey = function () {
        var _this = this;
        return (0, exports.ExchangeAccountsApiFp)(this.configuration).getExchangeAccountsCredentialsPublicKey().then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Returns a page include exchange accounts.
     * @summary Pagination list exchange accounts
