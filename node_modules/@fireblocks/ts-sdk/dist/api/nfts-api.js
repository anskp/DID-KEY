...
var NFTsApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        refreshNFTMetadata: function (id, xEndUserWalletId, idempotencyKey, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
         ...
         * @throws {RequiredError}
         */
        updateTokenOwnershipStatus: function (updateTokenOwnershipStatusDto, id, xEndUserWalletId, idempotencyKey, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
         ...
         * @throws {RequiredError}
         */
        updateTokensOwnershipSpam: function (updateTokensOwnershipSpamRequest, xEndUserWalletId, idempotencyKey, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
         ...
         * @throws {RequiredError}
         */
        updateTokensOwnershipStatus: function (updateTokensOwnershipStatusRequest, xEndUserWalletId, idempotencyKey, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
    ...
    return {
        ...
        refreshNFTMetadata: function (id, xEndUserWalletId, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.refreshNFTMetadata(id, xEndUserWalletId, idempotencyKey, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
        ...
        updateTokenOwnershipStatus: function (updateTokenOwnershipStatusDto, id, xEndUserWalletId, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.updateTokenOwnershipStatus(updateTokenOwnershipStatusDto, id, xEndUserWalletId, idempotencyKey, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
        ...
        updateTokensOwnershipSpam: function (updateTokensOwnershipSpamRequest, xEndUserWalletId, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.updateTokensOwnershipSpam(updateTokensOwnershipSpamRequest, xEndUserWalletId, idempotencyKey, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
        ...
        updateTokensOwnershipStatus: function (updateTokensOwnershipStatusRequest, xEndUserWalletId, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.updateTokensOwnershipStatus(updateTokensOwnershipStatusRequest, xEndUserWalletId, idempotencyKey, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
...
var NFTsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
        ...
        refreshNFTMetadata: function (requestParameters, options) {
            return localVarFp.refreshNFTMetadata(requestParameters.id, requestParameters.xEndUserWalletId, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Updates all tokens and balances per blockchain and vault account.
         * @summary Refresh vault account tokens
        ...
        updateTokenOwnershipStatus: function (requestParameters, options) {
            return localVarFp.updateTokenOwnershipStatus(requestParameters.updateTokenOwnershipStatusDto, requestParameters.id, requestParameters.xEndUserWalletId, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Updates tokens spam property for a tenant\'s token ownerships, in all tenant vaults.
         * @summary Update tokens ownership spam property
        ...
        updateTokensOwnershipSpam: function (requestParameters, options) {
            return localVarFp.updateTokensOwnershipSpam(requestParameters.updateTokensOwnershipSpamRequest, requestParameters.xEndUserWalletId, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Updates tokens status for a tenant, in all tenant vaults.
         * @summary Update tokens ownership status
        ...
        updateTokensOwnershipStatus: function (requestParameters, options) {
            return localVarFp.updateTokensOwnershipStatus(requestParameters.updateTokensOwnershipStatusRequest, requestParameters.xEndUserWalletId, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
...
var NFTsApi = /** @class */ (function (_super) {
    ...
    NFTsApi.prototype.refreshNFTMetadata = function (requestParameters) {
        var _this = this;
        return (0, exports.NFTsApiFp)(this.configuration).refreshNFTMetadata(requestParameters.id, requestParameters.xEndUserWalletId, requestParameters.idempotencyKey).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Updates all tokens and balances per blockchain and vault account.
     * @summary Refresh vault account tokens
    ...
    NFTsApi.prototype.updateTokenOwnershipStatus = function (requestParameters) {
        var _this = this;
        return (0, exports.NFTsApiFp)(this.configuration).updateTokenOwnershipStatus(requestParameters.updateTokenOwnershipStatusDto, requestParameters.id, requestParameters.xEndUserWalletId, requestParameters.idempotencyKey).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Updates tokens spam property for a tenant\'s token ownerships, in all tenant vaults.
     * @summary Update tokens ownership spam property
    ...
    NFTsApi.prototype.updateTokensOwnershipSpam = function (requestParameters) {
        var _this = this;
        return (0, exports.NFTsApiFp)(this.configuration).updateTokensOwnershipSpam(requestParameters.updateTokensOwnershipSpamRequest, requestParameters.xEndUserWalletId, requestParameters.idempotencyKey).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Updates tokens status for a tenant, in all tenant vaults.
     * @summary Update tokens ownership status
    ...
    NFTsApi.prototype.updateTokensOwnershipStatus = function (requestParameters) {
        var _this = this;
        return (0, exports.NFTsApiFp)(this.configuration).updateTokensOwnershipStatus(requestParameters.updateTokensOwnershipStatusRequest, requestParameters.xEndUserWalletId, requestParameters.idempotencyKey).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    return NFTsApi;
}(base_1.BaseAPI));
