...
export declare const TravelRuleValidateTransactionResponseBeneficiaryAddressTypeEnum: {
    readonly Unknown: "UNKNOWN";
    readonly Hosted: "HOSTED";
    readonly Unhosted: "UNHOSTED";
};
...
export declare const TravelRuleValidateTransactionResponseAddressSourceEnum: {
    readonly Unknown: "UNKNOWN";
    readonly AddressHash: "ADDRESS_HASH";
    readonly AddressGraph: "ADDRESS_GRAPH";
    readonly Chainalysis: "CHAINALYSIS";
    readonly Elliptic: "ELLIPTIC";
